    ...
    public function testCreateFields()
    {
        ...
        try {
            ...
            $field->setName('다중 선택이')
                ...
                ->setType("com.atlassian.jira.plugin.system.customfieldtypes:cascadingselect")//    ->setSearcherKey('com.atlassian.jira.plugin.system.customfieldtypes:grouppickersearcher')
            ;
